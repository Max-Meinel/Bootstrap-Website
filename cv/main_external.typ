...
#show: resume.with(
  author-info: (
    name: "Max Meinel",
    primary-info: [
      #link("mailto:max.christian.meinel@gmail.com")[max.christian.meinel\@gmail.com] | #link("https://max-meinel.github.io/Portfolio")[max-meinel.github.io/Portfolio]
    ],
    secondary-info: [
...
== Objective
Dual Studies student in Business Informatics (Software Engineering) graduating September 2026, seeking a full-time software development position. Five industry rotations across full-stack, cloud, and data engineering.
...
#multi-line-text(
  ...
  single-line-entry("Technologies:", [Next.js, React, TailwindCSS, PostgreSQL, Git, Docker, CI/CD], []),
...
#multi-line-text(
  ...
  single-line-entry([Interests:], [FPV Drones, Table Tennis (Regional League)], [])
)
